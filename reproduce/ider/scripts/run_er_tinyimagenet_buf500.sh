...
LOG_DIR="${PROJECT_ROOT}/output/runs/er_tinyimagenet_buf500_${RUN_TAG}"
...
echo "Experiment : PaperER baseline, TinyImageNet, buffer=500, CIL"
echo "Config     : ${CONFIG}"
echo "GPU        : ${GPU}"
echo "Seeds      : ${SEEDS}"
...
{
  echo "Experiment: PaperER TinyImageNet buffer=500 CIL"
  echo "Config: ${CONFIG}"
  echo "GPU: ${GPU}"
  echo "Seeds: ${SEEDS}"
  echo
