...
LOG_DIR="${PROJECT_ROOT}/output/runs/cifar100_buf500_5seeds_${RUN_TAG}"

cd "${PROJECT_ROOT}"
mkdir -p "${LOG_DIR}"

echo "Experiment : CIFAR100, buffer=500, CIL, 5 seeds"
echo "Config     : ${CONFIG}"
echo "GPU        : ${GPU}"
echo "Seeds      : ${SEEDS}"
...
{
  echo "Experiment: CIFAR100 buffer=500 CIL"
  echo "Config: ${CONFIG}"
  echo "GPU: ${GPU}"
  echo "Seeds: ${SEEDS}"
  echo
